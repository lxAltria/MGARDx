...
def run_mgard(folder, dims, ebs):
    ...
    np.savetxt("result/{}_mgard_revised_OB_20201104_psnr.txt".format(dataset_name), psnr)
    np.savetxt("result/{}_mgard_revised_OB_20201104_nrmse.txt".format(dataset_name), nrmse)
    np.savetxt("result/{}_mgard_revised_OB_20201104_ratio.txt".format(dataset_name), ratio)
